...
export default function SentryTestPage() {
  ...
  const triggerError = () => {
    throw new Error('Test error from Seller UI - This is intentional!');
  };

  const triggerCustomError = () => {
    Sentry.setTag('test_type', 'custom_seller_frontend');
    ...
    throw new Error('Custom test error with context from Seller UI');
  };

  const captureMessage = () => {
    Sentry.captureMessage('Test message from Seller UI', 'info');
      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white shadow-lg rounded-lg p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Sentry Test Page - Seller UI
          </h1>
          <p className="text-gray-600 mb-8">
            Use these buttons to test Sentry error tracking for the seller dashboard
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="mt-8 p-4 bg-gray-100 rounded-md">
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700">
                ...
                <li>
                  Errors should appear under the &quot;tecshop-seller-ui&quot; project
                </li>
