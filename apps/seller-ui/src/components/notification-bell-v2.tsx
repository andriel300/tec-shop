...
export function NotificationBellV2() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute left-full top-0 ml-2 w-96 bg-gray-900 border border-gray-700 rounded-lg shadow-xl z-50 max-h-[480px] overflow-hidden flex flex-col">
