...
DEFAULT_SERVICES=("api-gateway" "auth-service" "user-service" "seller-service" "product-service" "order-service" "admin-service" "chatting-service" "logger-service" "recommendation-service")
